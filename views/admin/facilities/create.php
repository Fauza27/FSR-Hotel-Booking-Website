<?php
// views/admin/facilities/create.php
...
<div class="admin-container">
    ...
    <div class="container mt-4">
        <h2 class="mb-3">Tambah Fasilitas</h2>
        <?php if (!empty($errors)): ?>
        ...
        <form method="post" action="">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="icon" id="icon" class="form-control" value="<?= htmlspecialchars($icon ?? '') ?>" required maxlength="50" oninput="previewIcon()">
                <div class="mt-2">
                    <span>Preview: </span>
                    <i id="iconPreview" class="bi bi-<?= htmlspecialchars($icon ?? '') ?>" style="font-size: 1.5em;"></i>
                    <span class="ms-2 text-muted" id="iconNamePreview"><?= htmlspecialchars($icon ?? '') ?></span>
                </div>
